...
function DeviceStatus(props){
  ...
  useEffect(() => {
    dataone = data1;
    datatwo = data2;
    Axios.get("https://gringrodno-a57ffb08e075.herokuapp.com/abonent-device/abonent-stats/" + id + "/" + dataone + "/" + datatwo)
      .then((response) => {
        if (response)
  ...
  useEffect(() => {
    Axios.get("https://gringrodno-a57ffb08e075.herokuapp.com/abonent-device/" + id)
      .then((response) => {
        if (response)
